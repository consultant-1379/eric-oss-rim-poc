...
*/ -}}
{{- define "eric-oss-rim-poc.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-rim-poc.mergeAnnotations" -}}
  {{- include "eric-oss-rim-poc.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-rim-poc.mergeLabels" -}}
  {{- include "eric-oss-rim-poc.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
