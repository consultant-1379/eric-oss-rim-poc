...
@Repository
public interface ParameterChangesRepo extends JpaRepository<ParametersChanges, ManagedObjectId> {
    List<ParametersChanges> findByMitigationState(MitigationState mitigationState);
}
