...
@Repository
public interface PmRopNrCellDuRepo extends JpaRepository<PmRopNRCellDU, MoRopId>, ExpiredRopDataRemoverRepo {
    List<PmRopNRCellDU> findByMoRopId_RopTime(long ropTime);
